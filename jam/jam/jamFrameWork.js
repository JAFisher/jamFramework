...
(function() {
	...
	jamFrameWork.objectList =  {children : new Array()};

	//push an eventID, objectName with the Event,then build all the Events once the view is initalized.
	jamFrameWork.eventList = {evt: new Array(), id: new Array(), fnc: new Array()};
